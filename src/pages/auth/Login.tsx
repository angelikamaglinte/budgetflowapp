...
export default function Login() {
  ...
  async function onSubmit(values: LoginForm) {
    ...
    try {
      ...
      // ProtectedRoute checks onboarding status and redirects if needed.
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left panel — branding */}
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-primary-600 to-primary-800 flex-col justify-between p-12">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-white text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition pr-10"
                />
                <button
                  type="button"
